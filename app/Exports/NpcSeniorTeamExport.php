...
class NpcSeniorTeamExport extends DefaultValueBinder implements FromCollection, WithMapping, WithHeadings, WithCustomValueBinder
{
    /**
    ...
    */
    ...
    {
        return Team::where('event', TeamEventEnum::NPC_SENIOR)->with('kota', 'anggota', 'anggotaKetua:anggota_id,team_id,user_id', 'userKetua', 'buktiPembayaran')->get();
    }
