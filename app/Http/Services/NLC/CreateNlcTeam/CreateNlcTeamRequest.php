...
class CreateNlcTeamRequest
{
	 ...
	 * @param CreateNlcAnggotaRequest[] $anggota
	 */
    public function __construct(
        ...
        string $ketua_nisn,
        string $ketua_alamat,
        ?string $ketua_id_line,
        ?string $ketua_id_facebook,
        string $status_id,
        string $team_name,
        // // TeamEventEnum $event,
        string $event,
    ...
    /**
     * @return CreateNlcAnggotaRequest[]
     */
