            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="center" bgcolor="#1a82e2"
                                                ...
                                                <a href="{{'https://schematics.its.ac.id/dashboard/reset-password?token='.$token}}"
                                                   target="_blank"
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        ...
                        <p style="margin: 0;">
                            <a href="{{'https://schematics.its.ac.id/dashboard/reset-password?token='.$token}}">
                                {{'https://schematics.its.ac.id/dashboard/reset-password?token='.$token}}
                            </a>
                        </p>
                    </td>
                </tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td align="center" bgcolor="#e9ecef"
                        ...
                        <p style="text-align: center; margin: 0;">©Schematics 2021</p>
                    </td>
                </tr>
            </table>
        </td>
